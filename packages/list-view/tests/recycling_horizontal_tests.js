...
module("Ember.ListView (horizontal) acceptance - View recycling", {
  setup: function() {
    css = Ember.$("<style>" +
            ".ember-list-view {" +
            "  overflow: auto;" +
...
test("recycling complex views short list", function(){
  ...
  equal(view.$('.ember-list-item-view').length, 2, "The correct number of columns were rendered (post-scroll to 50)");
  ...
  equal(view.$('.ember-list-item-view').length, 2, "The correct number of columns were rendered (post-scroll to 0)");
